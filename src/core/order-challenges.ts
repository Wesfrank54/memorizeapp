...
const GENERAL_ORDERS: OrderItem[] = [
  item('go-1', 'Take charge of this post and all government property in view.'),
  item(
    'go-2',
  ...
  item('go-3', 'Report all violations of orders I am instructed to enforce.'),
  item('go-4', 'Repeat all calls from any post more distant from the guard house than my own.'),
  item('go-5', 'Quit my post only when properly relieved.'),
  item(
    'go-6',
  ...
  item('go-7', 'Talk to no one except in the line of duty.'),
  item('go-8', 'Give the alarm in case of fire or disorder.'),
  item('go-9', 'Call the OOD in any case not covered by instructions.'),
  item('go-10', 'Salute all Officers and all colors and standards not cased.'),
  item(
    'go-11',
...
const CHAIN_OF_COMMAND: OrderItem[] = [
  item('coc-1', 'Class Recruit Division Commander(s) (RDC)'),
  item('coc-2', 'Class Officer(s)'),
  item('coc-3', 'Leading Chief Petty Officer, ODS'),
  item('coc-4', 'Deputy Director, ODS'),
  item('coc-5', 'Director, ODS'),
  item('coc-6', 'Command Master Chief, Officer Training Command, Newport'),
  item('coc-7', 'Executive Officer, Officer Training Command Newport'),
  item('coc-8', 'Commanding Officer, Officer Training Command Newport'),
  item('coc-9', 'Commander, Naval Service Training Command'),
  item('coc-10', 'Commander, Naval Education and Training Command'),
  item('coc-11', 'Chief of Naval Personnel'),
  item('coc-12', 'Chief of Naval Operations'),
  item('coc-13', 'Secretary of the Navy'),
  item('coc-14', 'Secretary of Defense'),
  item('coc-15', 'President of the United States'),
]

const NAVY_OFFICER_RANKS: OrderItem[] = [
  item('navy-o-w2', 'Chief Warrant Officer Two (CWO2)'),
  item('navy-o-w3', 'Chief Warrant Officer Three (CWO3)'),
  item('navy-o-w4', 'Chief Warrant Officer Four (CWO4)'),
  item('navy-o-w5', 'Chief Warrant Officer Five (CWO5)'),
  item('navy-o-o1', 'Ensign (ENS)'),
  item('navy-o-o2', 'Lieutenant Junior Grade (LTJG)'),
  item('navy-o-o3', 'Lieutenant (LT)'),
  item('navy-o-o4', 'Lieutenant Commander (LCDR)'),
  item('navy-o-o5', 'Commander (CDR)'),
  item('navy-o-o6', 'Captain (CAPT)'),
  item('navy-o-o7', 'Rear Admiral Lower Half (RDML)'),
  item('navy-o-o8', 'Rear Admiral (RADM)'),
  item('navy-o-o9', 'Vice Admiral (VADM)'),
  item('navy-o-o10', 'Admiral (ADM)'),
  item('navy-o-o11', 'Fleet Admiral (FADM)'),
]

const NAVY_ENLISTED_RANKS: OrderItem[] = [
  item('navy-e-e1', 'Seaman Recruit (SR)'),
  item('navy-e-e2', 'Seaman Apprentice (SA)'),
  item('navy-e-e3', 'Seaman (SN)'),
  item('navy-e-e4', 'Petty Officer Third Class (PO3)'),
  item('navy-e-e5', 'Petty Officer Second Class (PO2)'),
  item('navy-e-e6', 'Petty Officer First Class (PO1)'),
  item('navy-e-e7', 'Chief Petty Officer (CPO)'),
  item('navy-e-e8', 'Senior Chief Petty Officer (SCPO)'),
  item('navy-e-e9', 'Master Chief Petty Officer (MCPO)'),
  item('navy-e-mcpon', 'Master Chief Petty Officer of the Navy (MCPON)'),
]

const MARINE_OFFICER_RANKS: OrderItem[] = [
  item('usmc-o-w1', 'Warrant Officer (WO)'),
  item('usmc-o-w2', 'Chief Warrant Officer Two (CWO2)'),
  item('usmc-o-w3', 'Chief Warrant Officer Three (CWO3)'),
  item('usmc-o-w4', 'Chief Warrant Officer Four (CWO4)'),
  item('usmc-o-w5', 'Chief Warrant Officer Five (CWO5)'),
  item('usmc-o-o1', 'Second Lieutenant (2ndLt)'),
  item('usmc-o-o2', 'First Lieutenant (1stLt)'),
  item('usmc-o-o3', 'Captain (Capt)'),
  item('usmc-o-o4', 'Major (Maj)'),
  item('usmc-o-o5', 'Lieutenant Colonel (LtCol)'),
  item('usmc-o-o6', 'Colonel (Col)'),
  item('usmc-o-o7', 'Brigadier General (BGen)'),
  item('usmc-o-o8', 'Major General (MajGen)'),
  item('usmc-o-o9', 'Lieutenant General (LtGen)'),
  item('usmc-o-o10', 'General (Gen)'),
]
